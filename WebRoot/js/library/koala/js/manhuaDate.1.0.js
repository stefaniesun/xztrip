...
$(function() {
	$.fn.manhuaDate = function(options) {
		...
		//当鼠标离开控件上面的时候延迟3秒关闭
		$mhInput.live("mouseleave",function(e){
