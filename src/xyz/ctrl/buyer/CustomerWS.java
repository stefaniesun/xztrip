...
public class CustomerWS {
	...
	@ResponseBody
	public Map<String,Object> queryCustomerList(String userName,String nickName,String userTag,int enabled,
			int page,
			int rows){
		int pagesize = rows;
		int offset = (page-1)*pagesize;
		return customerSvc.queryCustomerList(userName,nickName,userTag,enabled,offset,pagesize);
	}
