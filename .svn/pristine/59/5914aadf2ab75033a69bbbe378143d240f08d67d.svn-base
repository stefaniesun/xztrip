...
//X 20151105增加上一月和下一月的事件响应
//if(_b==1){
//	_c.onNextMonth.call(_a,_a,_c.year,_c.month);
//}else if(_b==-1){
//	_c.onPrevMonth.call(_a,_a,_c.year,_c.month);
//}
//_c.onPrev.call(_a,_a,_c.year,_c.month);
//X 响应代码结束
};
function _f(_10,_11){
...
_13.val(_12.year);
//X 20151105增加上一年和下一年的事件响应
//_12.onNext.call(_10,_10,_12.year,_12.month);
//X 响应代码结束
};
function _14(_15){
...
_17(true);
//X 20151105
//_16.onMonth.call(_15,_15,_16.year,_16.month);
//X 事件响应结束
});
}
function _17(_19){
