...
//    public static final String appSecret ="f833becab6830d693a336e050f35f405";
    ...
    public static final String mch_id_js="1323014001";
    public static final String corpid_js="wx30eaaeefedd9d0a9";
    public static final String KEY_js ="086E7CA6906293007F9D92FF23432A2A";//api密匙
	
    
    public static Map<String,Object> doWxJsPay(WxBill bill){
    ...
    public static Map<String, String> registerJs(){
    	SortedMap<String, String> packageParams = new TreeMap<String, String>();
		packageParams.put("appId",corpid_js);
		packageParams.put("timestamp",System.currentTimeMillis()+"");
		packageParams.put("nonceStr",getNonceStr(32));
		// 根据之前添加的参数进行签名运算并加入map
		packageParams.put("signature", wxPaySign(packageParams).toUpperCase());
		return packageParams;
    }
    
	public static SortedMap<String, String> wxPayRequest2WxWebApp(String prepayid){
		SortedMap<String, String> params = new TreeMap<String, String>();
		params.put("appId",corpid_js);
		params.put("timeStamp", String.valueOf((int)(System.currentTimeMillis()/1000)));// 10位时间戳
		params.put("nonceStr",getNonceStr(32));
		params.put("package", "prepay_id="+prepayid);// 固定值
		// 根据之前添加的参数进行签名运算并加入map
		params.put("signType", "MD5");
		params.put("paySign", wxPaySign(params).toUpperCase());
		return  params;
	}
