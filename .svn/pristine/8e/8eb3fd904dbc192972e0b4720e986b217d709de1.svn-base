...
public class ProductScenicWS {
	...
	@RequestMapping(value="editProductScenicImage")
	@ResponseBody
	public Map<String,Object> editProductScenicImage(String numberCode,String imageUrl){
		return productScenicSvc.editProductScenicImage(numberCode, imageUrl);
	}
